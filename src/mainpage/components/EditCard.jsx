      ...
      <form className='flex flex-col items-center  w-[700px] h-[350px] shadow shadow-zinc-395 rounded-[16px]'>
        ...
        <div className='flex justify-end'>
          ...
          <div className='shrink w-500 h-14'>
            <button className='bg-white-400 font-bold text-[20px] rounded-[15px] w-[134px] h-[51px] hover:bg-zinc-400 border-solid border-2 border-zinc-500' type='Submit'>Close</button>
            <button className='bg-yellow-400 font-bold text-[20px] rounded-[15px] w-[134px] h-[51px] hover:bg-amber-400 ml-4' type='Submit'>Save</button>
          </div>    
        </div>
